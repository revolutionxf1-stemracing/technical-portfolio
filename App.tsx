...
import { Page4, Page6 } from './components/pages/Pages_4_5';
import { Page5 } from './components/pages/Page5_Simulations';
import { Page7, Page8 } from './components/pages/Pages_6_7';
